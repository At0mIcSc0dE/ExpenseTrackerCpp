...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlainText_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlainText_t qt_meta_stringdata_PlainText = {
    {
QT_MOC_LITERAL(0, 0, 9) // "PlainText"
...
QT_INIT_METAOBJECT const QMetaObject PlainText::staticMetaObject = { {
    QMetaObject::SuperData::link<QPlainTextEdit::staticMetaObject>(),
    qt_meta_stringdata_PlainText.data,
    qt_meta_data_PlainText,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PlainText::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlainText.stringdata0))
